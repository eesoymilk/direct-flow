...
describe('Share Calculations', () => {
  describe('calculateTotalAmount', () => {
    it('should calculate total amount correctly', () => {
      const quantity = 1000
      const pricePerShare = 10.50
      const expected = 10500.00
  ...
  describe('calculateTotalShares', () => {
    it('should sum all shares correctly', () => {
      ...
      const totalShares = holdings.reduce((sum, holding) => sum + holding.quantity, 0)
  ...
  describe('calculateSharesByType', () => {
    it('should group shares by type correctly', () => {
      const holdings = mockShareHoldings
      const sharesByType = holdings.reduce((acc, holding) => {
  ...
  describe('calculateTotalValue', () => {
    it('should calculate total portfolio value correctly', () => {
      ...
      expect(totalValue).toBe(20000.00) // 10000 + 10000
    })
  ...
  describe('roundToTwoDecimals', () => {
    it('should round to two decimal places', () => {
      ...
      expect(round(10.00001)).toBe(10.00)
    })
  })
})